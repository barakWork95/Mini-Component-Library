import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n}from"./iframe-DQT65nZ8.js";import{t as r}from"./jsx-runtime-CaZkqeYb.js";import{n as i,t as a}from"./Input-DT-RZKQn.js";var o,s,c,l,u,d,f,p,m,h;e((()=>{o=t(n(),1),i(),s=r(),c={title:`Components/Input`,component:a,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{disabled:{control:`boolean`}}},l={args:{placeholder:`Type something...`}},u={args:{label:`Email`,placeholder:`you@example.com`}},d={args:{label:`Username`,placeholder:`Enter username`,helperText:`Must be at least 3 characters`}},f={args:{label:`Password`,placeholder:`Enter password`,error:`Password is required`}},p={args:{label:`Disabled`,placeholder:`Can't touch this`,disabled:!0}},m={render:()=>{let[e,t]=(0,o.useState)(``);return(0,s.jsx)(a,{label:`Controlled Input`,value:e,onChange:e=>t(e.target.value),placeholder:`Type here...`,helperText:`${e.length} characters`,style:{width:`280px`}})}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
